...
class SelfJoinsDriver2 implements GlobalConst {
	...
	public SelfJoinsDriver2() {
	    ...
	    {
	        System.out.println("File Not Found: ../../Output/query_2b.txt " );
	    }
	    ...
	    switch (predicate2.get(2)) { // second attribute of second predicate
		 ...
		 switch (predicate2.get(1)) { //operand
		  ...
		  private void Query1b_CondExpr(CondExpr[] expr) {
			    ...
			    expr[0].operand1.symbol = new FldSpec (new RelSpec(RelSpec.outer),attribute_1_left);
			    ...
			    expr[1].operand1.symbol = new FldSpec (new RelSpec(RelSpec.outer),attribute_2_left); 
		  ...
		  public void Query1b() {
			    ...
			    try {
		          ...
		          SelfJoin2 sj2 = null;
		          try {
		            sj2 = new SelfJoin2 (Dtypes, 4, Dsizes,
		      				  10, 
		      				  am,"table2.in",
		      				  outFilter, proj, 2);
		          }
...
public class SelfJoinTest2 {
	public static void main(String argv[]) {
		boolean sortstatus;

		 long beggining = System.currentTimeMillis();

		    SelfJoinsDriver2 jjoin = new SelfJoinsDriver2();
