...
class JoinsDriver3 implements GlobalConst {
	...
	public JoinsDriver3() {
	    ...
	    try
	    {
	        File query_file = new File("../../Output/query_1b.txt");
	    ...
	    {
	        System.out.println("File Not Found: ../../Output/query_1b.txt " );
	    }
		 ...
		 switch (predicate2.get(1)) { //operand
		  ...
		  public void Query1b() {
			    ...
			    try {
		          ...
		          try {
		            nlj = new NestedLoopsJoins (Dtypes2, 3, Dsizes,
		      				  Dtypes, 4, Dsizes,
		      				  10,
		      				  am, "table2.in",
	...
	public static void main(String argv[]) {
		boolean sortstatus;
		 ...
		 long beggining = System.currentTimeMillis();
		    ...
		    JoinsDriver3 jjoin = new JoinsDriver3();
