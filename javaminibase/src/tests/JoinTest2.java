	...
	public JoinsDriver2() {
	    ...
	    catch (FileNotFoundException e)
	    {
		 ...
		 int num_table2 = Integer.parseInt(strn[1]); //size of table2
		    ...
		    try
		    {
		        File query_file = new File("../../Output/query_1a.txt");
		  ...
		  private void Query1a_CondExpr(CondExpr[] expr) {
			    ...
			    expr[0].operand1.symbol = new FldSpec (new RelSpec(RelSpec.outer),2);		//always 2 because of selection
		  ...
		  public void Query1a() {
			    ...
			    new FldSpec(new RelSpec(RelSpec.outer), attribute_left),
			    };
			    ...
			    proj[0] = new FldSpec(new RelSpec(RelSpec.outer), 1);			//always 1 because of selection
			    ...
			    try {
		          ...
		          try {
		            nlj = new NestedLoopsJoins (Dtypes2, 2, Dsizes,
		      				  Dtypes, 4, Dsizes,
		      				  10,
		      				  am, "table2.in",
